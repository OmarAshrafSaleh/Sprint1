...
router.get('/usersProducts/getProductsByUsername/:Sellername',usersProductsCtrl.getProductsByUsername);
...
router.post('/product/createProduct', usersProductsCtrl.createProduct);
